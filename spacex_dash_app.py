...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title='Success vs Failed Counts for Site')
        return fig
...
def get_scatter_plot(entered_site, payload_range):
    ...
    print("Min payload selected: ", min_payload)
    print("Max payload selected: ", max_payload)
    ...
    if entered_site == 'ALL':
        ...
        title='Total Successful Launches by Payload Mass and Booster Version Category')
        return fig
    else:
        ...
        fig = px.scatter(filtered_df, x = 'Payload Mass (kg)', y= 'class', 
        color='Booster Version Category', 
        title='Successful Launches for Site by Payload Mass and Booster Version Category')
        return fig
